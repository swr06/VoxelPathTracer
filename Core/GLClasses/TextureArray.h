...
namespace GLClasses
{
	...
	public :
		...
		void CreateArray(std::vector<std::string> paths, std::pair<int, int> texture_size, bool is_srgb ,bool gen_mips = true, GLint mag_filter = GL_NEAREST, bool limit_textures = false, GLuint min_filter = GL_NEAREST);
