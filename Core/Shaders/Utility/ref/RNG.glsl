...
float Random(vec2 v) { return FloatConstruct(Hash(asuint(v))); }
float Random(vec3 v) { return FloatConstruct(Hash(asuint(v))); }
float Random(vec4 v) { return FloatConstruct(Hash(asuint(v))); }
