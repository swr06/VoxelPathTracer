...
void ProjectOnSH(inout SH3_RGB sh, vec3 direction, vec3 value, float weight)
{
    // l, m = 0, 0
...
SH3_RGB ScaleSH(SH3_RGB sh, vec3 scale)
{
    SH3_RGB result;
...
vec3 EvaluateSH(SH3_RGB sh, vec3 direction)
{
    vec3 result = 0.0;
